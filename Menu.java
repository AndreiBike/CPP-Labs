...
public class Menu extends JFrame  implements Constants{
	...
	public Menu() {
		...
		button.setMaximumSize(new Dimension(BWIDTH, BHEIDTH));
		button.setAlignmentX(JComponent.CENTER_ALIGNMENT);
		button1.setMaximumSize(new Dimension(BWIDTH, BHEIDTH));
		button1.setAlignmentX(JComponent.CENTER_ALIGNMENT);
		button2.setMaximumSize(new Dimension(BWIDTH, BHEIDTH));
		button2.setAlignmentX(JComponent.CENTER_ALIGNMENT);
		playPC.setMaximumSize(new Dimension(BWIDTH, BHEIDTH));
		playPC.setAlignmentX(JComponent.CENTER_ALIGNMENT);
		Level.setMaximumSize(new Dimension(BWIDTH, 50));
